...
describe('CreateDocument', function() {
  ...
  describe('Component Functions', function() {
    it('should update title field on change', function() {
      render(
        <BrowserRouter>
          <Provider store={store}>
            <CreateDocument />
    ...
    it('should update content field on change', function() {
      render(
        <BrowserRouter>
          <Provider store={store}>
            <CreateDocument />
    ...
    it('should show error toast when submitting without a role', function() {
      render(
        <BrowserRouter>
          <Provider store={store}>
            <CreateDocument />
